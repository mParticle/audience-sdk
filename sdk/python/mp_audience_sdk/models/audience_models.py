...
#   timestamp: 2025-06-19T19:18:47+00:00
...
class StringExpression(RootModel[Union[str, ModelPath]]):
    root: Union[str, ModelPath] = Field(..., title="StringExpression")
...
class DateLiteral(RootModel[Union[AbsoluteDate, RelativeDate]]):
    root: Union[AbsoluteDate, RelativeDate] = Field(..., title="DateLiteral")
...
class DateLiteralExpression(BaseModel):
    ...
    date: Union[AbsoluteDate, RelativeDate]


class Literal(RootModel[Union[bool, float, str, DateLiteral, ModelPath, Location]]):
    root: Union[bool, float, str, DateLiteral, ModelPath, Location] = Field(
        ...,
...
class LocationExpression(RootModel[Union[Location, ModelPath]]):
    root: Union[Location, ModelPath] = Field(
        ...,
...
class LocationBooleanExpression(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class DateExpression(RootModel[Union[DateLiteralExpression, ModelPath]]):
    root: Union[DateLiteralExpression, ModelPath] = Field(
        ...,
...
class AudienceDefinition(BaseModel):
    ...
    audience: BooleanExpression = Field(..., title="Audience")
...
class NumberExpression(
    RootModel[
        Union[float, ModelPath, BinaryNumberExpression, AggregateNumberExpression]
    ]
):
    root: Union[float, ModelPath, BinaryNumberExpression, AggregateNumberExpression] = (
        Field(
            ...,
...
UnaryBoolExpression.model_rebuild()
NumberBoolExpression.model_rebuild()
LogicalBoolExpression.model_rebuild()
LogicalManyBoolExpression.model_rebuild()
