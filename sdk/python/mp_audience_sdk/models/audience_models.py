...
#   timestamp: 2025-05-22T18:07:34+00:00
...
class AudienceDefinition(BaseModel):
    ...
    audience: LogicalAudienceExpressions = Field(..., title="Audience")
...
class LogicalAudienceExpressions(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    expressions: List[Union[LogicalAudienceExpressions, Expression]]
    operator: LogicalOperator
