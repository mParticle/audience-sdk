...
#   timestamp: 2025-05-22T18:45:06+00:00
...
class AudienceDefinition(BaseModel):
    ...
    audience: LogicalAudienceExpression = Field(..., title="Audience")
...
class LogicalAudienceExpression(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    expressions: List[Union[LogicalAudienceExpression, Expression]]
    operator: LogicalOperator
