...
#   timestamp: 2025-06-11T22:59:04+00:00
...
class DateRangeOperand(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    from_: Union[RelativeDate, AbsoluteDate] = Field(..., alias="from")
    to: Union[RelativeDate, AbsoluteDate]
...
class ModelAggregationOperand(BaseModel):
    ...
    recency: Optional[Union[DateOperand, DateRangeOperand]] = None
