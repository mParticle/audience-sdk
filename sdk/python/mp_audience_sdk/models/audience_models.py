...
#   timestamp: 2025-05-22T20:42:00+00:00
...
class Operand(RootModel[Union[bool, float, str, DateOperand, ModelPath]]):
    root: Union[bool, float, str, DateOperand, ModelPath] = Field(
        ...,
...
class AudienceDefinition(BaseModel):
    ...
    audience: LogicalExpression = Field(..., title="Audience")
