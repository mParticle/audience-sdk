...
#   timestamp: 2025-07-01T01:01:04+00:00
...
class Operator(
    RootModel[
        "LogicalBoolOperator | LocationBoolOperator | AggregationNumberOperator | BinaryNumberOperator | AudienceOperator | ListBoolOperator | StringBoolOperator | NumberBoolOperator | UnaryBoolOperator"
    ]
):
    root: (
        LogicalBoolOperator
...
class Expression(
    RootModel[
        "ValueExpression | IUnaryExpression | IBinaryExpression | IManyExpression | IAggregateExpression | BoolExpression | NumberExpression | StringExpression | LocationExpression | DateExpression | Literal"
    ]
):
    root: (
        ValueExpression
...
class IUnaryExpression(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    operand: Expression
