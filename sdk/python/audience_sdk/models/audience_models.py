...
#   timestamp: 2025-05-16T00:50:07+00:00
...
class AudienceDefinition(BaseModel):
    ...
    audience: LogicalAudienceQueries = Field(..., title='Audience')
...
class Operand(
    RootModel[Union[bool, float, str, DateOperand, ModelPath, ArithmeticOperand]]
):
    root: Union[bool, float, str, DateOperand, ModelPath, ArithmeticOperand] = Field(
        ...,
